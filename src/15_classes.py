...
class Waypoint(LatLong):
    ...
    def __str__(self):
        return(f"A waypoint called {self.name} at latitude {self.lat} and longitude {self.lon}.")
...
class Geocache(Waypoint):
    ...
    def __str__(self):
        return(f"A geocache called {self.name} at latitude {self.lat} and longitude {self.lon} of difficulty {self.difficulty} and size {self.size}.")
